...
{
    /// <summary>
    /// Zentraler, statischer Logger fuer alle Pifflers-Crestron-Projekte.
    /// Konsolen-Kommando "deebug on|off|status|help" schaltet die Ausgabe zur Laufzeit.
    /// (Name "deebug", weil "debug" auf dem Controller bereits belegt ist.)
    /// Herkunft: portiert aus dem CCPExam-Programm (MasterOfKaraoke.Utilities.Logger).
    /// </summary>
    public static class Logger
    {
        public const string DebugCommandName = "deebug"; // "debug" ist schon belegt =(
        ...
        // Standardmaessig aus, damit die Konsole ruhig bleibt. Mit "deebug on" einschalten.
